...
dependencies {
    ...
    implementation("com.google.maps.android:maps-compose-widgets:6.12.0")
    ...
    implementation("com.google.accompanist:accompanist-swiperefresh:0.36.0") // Or latest version
    ...
    implementation("androidx.compose.ui:ui-tooling-preview-android:1.9.2@aar")
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.10.2")
